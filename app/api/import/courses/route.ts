  ...
  try {
    ...
    for (const course of courses) {
      const courseData = {
        ...
        training_days: course.trainingDays || null,
        ...
        daily_hours: course.dailyHours || null,
        ...
        tuition: course.tuition || null,
        special_lecture_1: truncate(course.specialLecture1, 200),
        special_lecture_1_time: course.specialLecture1Time || null,
        special_lecture_2: truncate(course.specialLecture2, 200),
        special_lecture_2_time: course.specialLecture2Time || null,

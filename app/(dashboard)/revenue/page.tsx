...
interface CourseRevenue {
  ...
  unitPeriodEnd: string    // 과정 기준 단위기간 종료일
      ...
      {data && !loading && (
        <>
          ...
          <div className="text-xs text-gray-500 bg-blue-50 border border-blue-200 rounded-lg px-4 py-2">
            {year}년 · 개강일 기준 1개월 단위기간 · 단위기간 종료일 기준 지급 슬롯(1~15일→상반기, 16일~말일→하반기) 결정 ·
                                    ...
                                    <table className="w-full text-xs border-collapse">
                                      <thead>
                                        <tr className="text-gray-500 border-b border-gray-200">
                                          ...
                                          <th className="text-center py-2 px-2 font-semibold">단위기간</th>
                                      ...
                                      <tbody>
                                        {filteredCourses
                                          ...
                                          .map((c) => (
                                            <tr key={c.trainingId} className="border-b border-gray-100 hover:bg-white">
                                              ...
                                              <td className="py-2 px-2 text-center font-mono text-gray-500 whitespace-nowrap">
                                                {c.unitPeriodStart?.slice(5)} ~ {c.unitPeriodEnd?.slice(5)}
                                              </td>
                                        ...
                                        <tr className="bg-gray-100 font-semibold">
                                          <td colSpan={10} className="py-2 px-2 text-right text-gray-600">소계</td>
